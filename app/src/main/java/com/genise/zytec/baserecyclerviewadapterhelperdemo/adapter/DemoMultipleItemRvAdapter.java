...
import com.genise.zytec.baserecyclerviewadapterhelperdemo.adapter.provider.ImgItemProvider;
import com.genise.zytec.baserecyclerviewadapterhelperdemo.adapter.provider.TextImgItemProvider;
import com.genise.zytec.baserecyclerviewadapterhelperdemo.adapter.provider.TextItemProvider;
...
public class DemoMultipleItemRvAdapter extends MultipleItemRvAdapter<NormalMultipleEntity, BaseViewHolder> {
    ...
    public static final int TYPE_TEXT_IMAGE = 300;
